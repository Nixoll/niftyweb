      ...
      {showEstimateForm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[95vh] overflow-y-auto">
            ...
            <form onSubmit={handleEstimateSubmit} className="p-6">
              {currentStep === 1 && (
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  ...
                  {estimateData.serviceType === 'web-development' && (
                    <>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Content Management
                        ...
                        <select
                          ...
                          value={estimateData.contentManagement}
                          onChange={handleEstimateChange}
                          className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm pr-8"
                        >
                          <option value="">Select CMS preference</option>
                      ...
                      <div>
                        ...
                        <select
                          name="hosting"
                          value={estimateData.hosting}
                          onChange={handleEstimateChange}
                          className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm pr-8"
                        >
                          <option value="">Select hosting preference</option>
                          <option value="we-manage">You manage hosting</option>
                          <option value="client-manages">I'll manage hosting</option>
                          <option value="recommend">Please recommend</option>
                        </select>
                      </div>
                    </>
                  )}

                  {estimateData.serviceType === 'design-services' && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      <select
                        name="designStyle"
                        value={estimateData.designStyle}
                        onChange={handleEstimateChange}
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm pr-8"
                      >
                  ...
                  <div>
                    ...
                    <select
                      name="maintenance"
                      value={estimateData.maintenance}
                      onChange={handleEstimateChange}
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm pr-8"
                    >
